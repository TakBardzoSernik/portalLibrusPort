...
public class Oceny {
    ...
    final int iFinal        = 7;
    final String rowsCssQuery = ">tr:not([name])";
    final String cellsCssQuery = ">td:not([class=\"center micro screen-only\"])";
    ...
    public void collectData(Document htmlDoc){
        ...
        Elements rows = table.select(rowsCssQuery);
        ...
        for (Element row : rows)  {
            ...
            Elements cells = row.select(cellsCssQuery);
